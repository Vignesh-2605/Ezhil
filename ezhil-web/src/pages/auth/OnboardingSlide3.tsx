...
import { SceneWin } from '../../components/illustrations/OnboardingScenes';
...
export const OnboardingSlide3: React.FC = () => {
  ...
  return (
    <div className="bg-bg-deep text-on-surface min-h-dvh font-body-tamil overflow-hidden relative select-none grid grid-cols-1 lg:grid-cols-12">
      ...
      <section className="hidden lg:flex lg:col-span-7 relative flex-col items-center justify-center border-r border-white/5 bg-[radial-gradient(circle_at_30%_30%,_rgba(76,175,130,0.08)_0%,_transparent_60%)]">
        {/* Background ambient glows */}
        <div className="absolute top-1/4 left-1/4 w-[400px] h-[400px] rounded-full bg-success/5 blur-[120px] animate-pulse" />
        ...
        <div className="relative z-10 scale-110">
          {/* Orbiting rings */}
          <div className="absolute -inset-10 rounded-full border border-success/10 animate-spin [animation-duration:24s]" />
          <div className="absolute -inset-6 rounded-full border border-dashed border-success/15 animate-spin [animation-duration:19s] [animation-direction:reverse]" />
          
          <div className="relative animate-float">
            <div className="absolute inset-0 bg-success/20 opacity-30 blur-3xl rounded-full" />
            <div className="relative z-10 drop-shadow-[0_24px_50px_rgba(0,0,0,0.55)]">
              <SceneWin size={280} />
            </div>
            {/* Sparkle particles */}
            <div className="absolute -top-3 right-6 w-4 h-4 rounded-full bg-success animate-ping opacity-60" />
            <div className="absolute -bottom-4 left-6 w-3 h-3 rounded-full bg-primary-fixed animate-pulse" />
      ...
      <section className="col-span-1 lg:col-span-5 flex flex-col justify-between p-6 md:p-10 relative z-10 bg-bg-sidebar/20 backdrop-blur-md">
        ...
        <div className="absolute inset-0 pointer-events-none lg:hidden -z-10 overflow-hidden">
          <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[300px] h-[300px] rounded-full bg-success/5 blur-[100px]" />
        ...
        <main className="my-auto py-8 flex flex-col items-center w-full">
          ...
          <div className="lg:hidden relative mb-6 animate-float">
            <div className="absolute inset-0 bg-success/15 opacity-30 blur-2xl rounded-full" />
            <div className="relative z-10 drop-shadow-[0_14px_30px_rgba(0,0,0,0.5)]">
              <SceneWin size={150} />
            </div>
            <div className="absolute -top-1 -right-1 w-2.5 h-2.5 rounded-full bg-success animate-ping opacity-60" />
          </div>
          ...
          <div className="min-w-[300px] w-[320px] max-w-[360px] min-h-[500px] shrink-0 glass-card r-hero surface-lit grain p-8 flex flex-col items-center text-center border-white/5 animate-slide-in relative overflow-hidden">
            {/* Accent light stripe */}
            <div className="absolute top-0 inset-x-0 h-[2px] bg-gradient-to-r from-transparent via-success/45 to-transparent" />
            ...
            <div className="flex-1 flex flex-col justify-center space-y-4 mb-6 w-full whitespace-normal break-normal break-words">
              <h1 className="font-display-tamil text-3xl font-extrabold text-success">
                வெல்லலாம்!
              </h1>
              <h2 className="font-dashboard-title text-xl font-bold text-on-surface">
                Let's Win!
              </h2>
              <div className="w-12 h-[2px] bg-success/20 mx-auto my-3" />
              <p className="font-body-tamil text-sm text-on-surface-variant leading-relaxed px-2">
                Track your progress, earn badges, and climb the leaderboard as you master Tamil literacy.
              </p>
            </div>
            ...
            <div className="mt-auto w-full flex flex-col items-center gap-6">
              ...
              <div className="flex items-center justify-center gap-2.5">
                ...
                />
                <div className="h-1.5 w-6 bg-success rounded-full shadow-[0_0_8px_rgba(76,175,130,0.5)] transition-all duration-300" />
              </div>
              ...
              <div className="flex items-center justify-center gap-3 w-full h-12">
                ...
                <button 
                  onClick={() => navigate('/role-selection')}
                  className="flex-1 h-12 bg-gradient-to-r from-primary-fixed-dim to-primary-fixed text-bg-deep font-dashboard-title font-extrabold r-chip flex items-center justify-center gap-1.5 active:scale-[0.97] hover:scale-[1.01] hover:shadow-[0_0_24px_rgba(98,249,238,0.4)] transition-all duration-200 cursor-pointer text-xs"
                >
                  <span>Get Started</span>
                  <span className="material-symbols-outlined font-extrabold text-base">
                    arrow_forward
                  </span>
                </button>
              </div>
