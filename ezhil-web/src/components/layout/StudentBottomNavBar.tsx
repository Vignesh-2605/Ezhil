...
const NAV = [
  { to: '/student/home',    icon: 'home',           label: 'முகப்பு'    },
  { to: '/student/lessons', icon: 'menu_book',      label: 'பாடங்கள்'   },
  { to: '/student/games',   icon: 'sports_esports', label: 'விளையாட்டு' },
  { to: '/student/journey', icon: 'map',            label: 'பயணம்'      },
];

export const StudentBottomNavBar: React.FC = () => (
        ...
        {({ isActive }) => (
          <>
            ...
            <span className={clsx(
              ...
              isActive ? 'bg-primary-fixed/10 border border-primary-fixed/25 shadow-[0_0_18px_rgba(98,249,238,0.3)]' : 'bg-transparent border border-transparent',
            )} />
            <span
